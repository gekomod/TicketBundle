 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Gekomod\TicketBundle\Repository\TicketRepository")
...
class Ticket
{
     ...
     * Set category
     *
     * @param \Gekomod\TicketBundle\Entity\Category $category
     *
     * @return Ticket
     */
    public function setCategory(\Gekomod\TicketBundle\Entity\Category $category = null)
    {
     ...
     * Get category
     *
     * @return \Gekomod\TicketBundle\Entity\Category
     */
